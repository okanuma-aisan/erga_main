...
private:
  ...
  {
    if(std::fabs(curvature) < m_param.low_curvature_thresh_curvature)
    {
      std::stringstream ss;
      ss << "LOW , " << curvature << " , " << m_param.low_curvature_thresh_curvature;
      curv_highlow = ss.str();
    }
    else
    {
      std::stringstream ss;
      ss << "HIGH , " << curvature << " , " << m_param.low_curvature_thresh_curvature;
      curv_highlow = ss.str();
    }
