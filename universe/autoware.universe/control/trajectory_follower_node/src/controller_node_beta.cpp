  ...
  , beta_(0.0)
{
  ...
  sub_beta_ = create_subscription<std_msgs::msg::Float64>(
    "~/input/beta", rclcpp::QoS{1}, std::bind(&Controller::onBeta, this, _1));
...
void Controller::onBeta(const std_msgs::msg::Float64::SharedPtr msg)
{
  beta_ = msg->data;
}
