...
def launch_setup(context, *args, **kwargs):
    ...
    print(LaunchConfiguration("lanelet2_map_path").perform(context))
    print(lanelet2_map_loader_param)
    ...
    print(LaunchConfiguration("map_projector_info_path").perform(context))
