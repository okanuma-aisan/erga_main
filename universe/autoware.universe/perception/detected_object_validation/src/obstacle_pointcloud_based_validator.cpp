  ...
  sync_(SyncPolicy(10), objects_sub_, obstacle_pointcloud_sub_)
{
  ...
  decision_mobileye_ = declare_parameter<bool>("decision_mobileye", false);
}
  ...
  const sensor_msgs::msg::PointCloud2::ConstSharedPtr & input_obstacle_pointcloud)
{
  ...
  for (size_t i = 0; i < transformed_objects.objects.size(); ++i) {
    ...
    if(decision_mobileye_ == false && object.detection_device == autoware_auto_perception_msgs::msg::DetectedObject::DEVICE_MOBILEYE)
    {
