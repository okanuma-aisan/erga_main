...
### erga ###
ros2 launch autoware_erga_launch logging_simulator.2.launch.xml map_path:=/home/sit/load_data/okabe/pcd/create_wan/okabe_mgrs lanelet2_map_file:=lanelet2_map_okabe_r15.osm pointcloud_map_file:=okabe_MGRS_0.5.pcd vehicle_model:=erga_vehicle sensor_model:=erga_sensor_kit map_projector_info_path:=/home/sit/load_data/okabe/pcd/create_wan/okabe_mgrs/map_projector_info.yaml
