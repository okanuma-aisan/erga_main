...
{
  declareParameter("video_device", "/dev/media0", "Path to video device", true);
  declareParameter(
    "camera_info_url", "/home/sit/autoware_erga/src/original_nodes/ros2_v4l2_camera/calib_dot_3/camera_info_dot3_v4l2.yaml", "The location for getting camera calibration data",
    true);
  declareParameter("camera_frame_id", "traffic_light_left_camera", "Frame id inserted in published image", true);
}
