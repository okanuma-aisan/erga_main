...
#else
			command_steer = std::pow(cmd_tire_angle,6)*283.1893+std::pow(cmd_tire_angle,5)*(133.1275)+std::pow(cmd_tire_angle,4)*(-96.5182)+std::pow(cmd_tire_angle,3)*(-10.97506019)+std::pow(cmd_tire_angle,2)*-43.76120413+cmd_tire_angle*1111.071241+3.609668+car_info_.steer_input_center_;
