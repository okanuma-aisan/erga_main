...
def generate_launch_description():
    ...
    add_launch_arg('serial1', '101138')#kvaserのシリアル番号１番目
    add_launch_arg('serial2', '0')#kvaserのシリアル番号２番め
    add_launch_arg('select_can_device', 'pedal')#担当車両デバイス
    add_launch_arg('wait_time_ms', '10')#kvaser受信のウェイトタイム(ミリ秒)
    add_launch_arg('pedal_input_center', '1024')#joyボードのペダル中央値
    add_launch_arg('pedal_input_brake_max', '1941')#joyボードのペダルの最大値(ブレーキ)
    add_launch_arg('pedal_input_brake_max', '100')#joyボードのペダルの最小値(アクセル)
            ...
            composable_node_descriptions=[
                ...
                ComposableNode(#autowareの情報からcanの操舵数値を計算するノード
                    ...
                    parameters=[
                        ...
                        {'pedal_input_brake_max': LaunchConfiguration('pedal_input_brake_max')},
                        {'pedal_input_brake_max': LaunchConfiguration('pedal_input_brake_max')},
                    ]
                ),
