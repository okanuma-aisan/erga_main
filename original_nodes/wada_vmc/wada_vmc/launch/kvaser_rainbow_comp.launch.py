        ...
        composable_node_descriptions=[
            ...
            ComposableNode(#自動運転許可ノード
                ...
                remappings=[
                    ...
                    ("scenario_trajectry", "/planning/scenario_planning/lane_driving/motion_planning/obstacle_cruise_planner/virtual_wall"),
                    #("pedal_info_20221111", "can501"),
                    #("steer_info_20221111", "can502"),
                    ("can_info_20210103", "can501"),
                ],
            ),
        ],
    )
