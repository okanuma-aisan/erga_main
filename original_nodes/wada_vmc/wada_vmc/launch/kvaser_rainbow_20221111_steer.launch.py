...
def generate_launch_description():
    ...
    add_launch_arg('steer_input_center', '0')#joyボードのステア中央値
    add_launch_arg('steer_input_left_max', '2500')#joyボードのステア入力左回りの最大値
    add_launch_arg('steer_input_right_min', '-2500')#joyボードのステア入力右回りの最小値
