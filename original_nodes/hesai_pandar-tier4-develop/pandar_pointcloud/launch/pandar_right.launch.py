...
def generate_launch_description():
    ...
    add_launch_arg('pcap', '')
    add_launch_arg('device_ip', '192.168.5.200')
    add_launch_arg('lidar_port', '2371')
    add_launch_arg('gps_port', '10113')
    add_launch_arg('scan_phase', '0.0')
    add_launch_arg('return_mode', 'Dual')
    add_launch_arg('dual_return_distance_threshold', '0.1')
    add_launch_arg('model', 'PandarQT')
    add_launch_arg('frame_id', 'lidar_right')
    add_launch_arg('calibration', '$(find-pkg-share pandar_pointcloud)/config/qt.csv')
