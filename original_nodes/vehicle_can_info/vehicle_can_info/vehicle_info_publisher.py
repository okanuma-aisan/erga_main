...
class VehicleInfoPublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter("scale_factor", value=1.013314)
        ...
        self.velocity_report_publisher_ = self.create_publisher(VelocityReport, 'velocity_report', 10)
        ...
        with canlib.openChannel(channel=self.my_channel) as ch:
            ...
            while True:
                ...
                if pgn == 65215:
                    ...
                    speed_avg = (front_axle + rear_axle) * self.scale_factor
